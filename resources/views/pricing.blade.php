		...
		<div class="row">
			<div class="col-12 text-center">
				...
				<ol class="breadcrumb p-0 m-0">
				  ...
				  <li class="breadcrumb-item active">Subscription Table</li>
				</ol>
			</div>
		</div>
	</div>
		...
		<div class="row">
			<div class="col-12">
				<div class="section-title">
					<h3>Subscribe <span class="alternate">Now</span></h3>
			...
			<div class="col-lg-4 col-md-6">
				...
				<div class="pricing-item">
					...
					<div class="pricing-footer text-center">
						<a href="#" class="btn btn-transparent-md">Proceed to Subscribe</a>
					</div>
				</div>
			</div>
			<div class="col-lg-4 col-md-6">
