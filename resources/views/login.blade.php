	...
	<div class="container-fuild p-0">
		<div class="row">
			...
			<div class="col-lg-12 col-md-12 p-0">
              ...
              <div class="col-md-6">
                <input type="text" class="form-control main" placeholder="username">
              </div>
							<div class="col-md-6">
								<input type="password" class="form-control main" placeholder="password">
							</div>
							<div class="col-md-6">
								<button type="submit" class="btn btn-white-md mb-3 form-control">Login</button>
							</div>
              <div class="col-md-6">
                <button type="submit" class="btn btn-white-md form-control">Forget password</button>
              </div>
						</form>
					</div>
				</div>
