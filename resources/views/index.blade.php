      ...
      <ul class="navbar-nav mx-auto">
		...
		<li class="nav-item dropdown active dropdown-slide">
          ...
          <div class="dropdown-menu">
			...
			<a class="dropdown-item" href="#">Honary Members</a>
		...
		<li class="nav-item dropdown dropdown-slide">
          ...
          <div class="dropdown-menu">
            ...
            <a class="dropdown-item" href="#">Industry Events</a>
          </div>
		</li>
		<li class="nav-item dropdown dropdown-slide">
          ...
          <!-- Dropdown list -->
          <div class="dropdown-menu">
            <a class="dropdown-item" href="upcoming-events">African Journal</a>
            <a class="dropdown-item" href="past-events">Newsletter</a>
          </div>
		</li>
		<li class="nav-item dropdown active dropdown-slide">
          ...
          <!-- Dropdown list -->
          <div class="dropdown-menu">
			<a class="dropdown-item" href="#">Agriculture without frontiers</a>
			<a class="dropdown-item" href="#">Collaborative masters in agriculture and applied economics</a>
			<a class="dropdown-item" href="#">Become a Member</a>
			<a class="dropdown-item" href="#">Honary Members</a>
			<a class="dropdown-item" href="#">Member Directory</a>
          </div>
