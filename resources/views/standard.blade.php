...
@foreach($sub as $user)
    <?php
		...
		$dueday = $user->dueday;
		$activatedday = $user->activatedday;
    ?>
@endforeach

    <?php $i=0 ?>
@foreach($allsub as $index => $all)
	@if($all->type == 'standard')
		<?php $i++ ?>
	@endif
@endforeach
	...
	<div class="container">
		<div class="row">
			<div class="col-12 text-center">
				<div class="title">
					<h3>welcome to standard membership</h3>
				</div>
				<ol class="breadcrumb p-0 m-0">
				  <li class="breadcrumb-item"><a href="/">Home</a></li>
				  <li class="breadcrumb-item active">standard membership</li>
				</ol>
			</div>
		</div>
	</div>
		...
		<div class="row">
			...
			<div class="col-lg-8 col-md-6 align-self-center">
				<div class="content-block">
					<h2>About standard membership plan  <span class="alternate">of GAAE</span></h2>
...
<section class="section speakers bg-speaker overlay-lighter">
	<div class="container">
		<div class="row">
			<div class="col-12">
				...
				<div class="section-title white">
					<h3>subscribers <span class="alternate">You Should Know</span></h3>
		...
		<div class="row">
			...
			@if($icons->type == 'standard' && $icons->icon == '1')
		...
		<div class="row">
			<div class="col-12">
				<div class="section-title">
					<h3>Rules Guiding The <span class="alternate">Plan</span></h3>
		...
		<div class="row">
			<div class="col-md-8 mx-auto">
				<div class="text-center p-5 shadow rounded">
					<h2 class="mb-3">Your subscription status</h2>
					<ul class="list-unstyled mb-4">
						<li>{{$sstatus ?? 'not yet a subscriber'}}</li>
						<li>activated on {{$activatedday ?? '...'}}</li>
						<li>due on {{$dueday ?? '...'}}</li>
